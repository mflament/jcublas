...
public enum CUjit_option implements NativeEnum {
     ...
     * used with cuLinkAPIs as the linker requires exact matches.\n
    ...
    CU_JIT_LTO(20),
    /**
     * @deprecated Control single-precision denormals (-ftz) support (0: false, default).
    ...
    CU_JIT_FTZ(21),
    /**
     * @deprecated Control single-precision floating-point division and reciprocals
    ...
    CU_JIT_PREC_DIV(22),
    /**
     * @deprecated Control single-precision floating-point square root
    ...
    CU_JIT_PREC_SQRT(23),
    /**
     * @deprecated Enable/Disable the contraction of floating-point multiplies
    ...
    CU_JIT_FMA(24),
    /**
     * @deprecated Array of kernel names that should be preserved at link time while others
     * can be removed.\n
    ...
    /**
     * @deprecated Array of variable names (__device__ and/or __constant__) that should be
    ...
    /**
     * @deprecated This option serves as a hint to enable the JIT compiler/linker
