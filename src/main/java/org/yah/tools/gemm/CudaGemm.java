...
//            System.out.printf("gridDim=%s blockDim=%s%n", executionConfig.gridDim(), blockDim);
            ...
            gemmKernels.sgemm(executionConfig, M, N, K, alpha, gpuA, tlda, gpuB, ldb, beta, gpuC, ldc);
...
//            System.out.printf("gridDim=%s blockDim=%s%n", executionConfig.gridDim(), blockDim);
            start = System.nanoTime();
            gemmKernels.dgemm(executionConfig, M, N, K, alpha, gpuA, tlda, gpuB, ldb, beta, gpuC, ldc);
            cuda.cudaDeviceSynchronize().check();
